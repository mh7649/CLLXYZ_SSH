            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="easyui-datebox form-control easyui-validatebox"
                           data-options="required:true, novalidate:true" name="start_time" style="width:354px;"
                           id="start_time"/>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <input type="text" class="easyui-datebox form-control easyui-validatebox"
                           data-options="required:true, novalidate:true" name="end_time" style="width: 354px;"
                           id="end_time"/>
                </div>
            </div>
            <div class="form-group">
